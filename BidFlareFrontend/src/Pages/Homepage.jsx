...
function Homepage() {
  ...
  const cars = [
    ...
    { id: 2, img: "/car4.jpg", name: "2020 Rolls Royce Ghost", price: "$299,000", year: 2020, brand: "Rolls Royce", model: "Ghost", features: "Feature 1, Feature 2", description: "Description of the car" },

    { id: 3, img: "/car2.jpg", name: "Bugatti Veyron Vision GT", price: "$2,555,000", year: 2019, brand: "Bugatti", model: "Veyron Vision GT", features: "Feature 1, Feature 2", description: "Description of the car" },

    { id: 4, img: "/bmw.png", name: "BMW M5 Coupe", price: "$319,000", year: 2018, brand: "BMW", model: "M5 Coupe", features: "Feature 1, Feature 2", description: "Description of the car" },
